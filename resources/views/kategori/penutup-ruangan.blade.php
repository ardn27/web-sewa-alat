...
<div class="header-categories container fluid w-full h-30 bg-warning p-1 rounded">
    <p class="fs-1 text-center text-light">Penutup Ruangan</p>
...
<div class="container-fluid">
    <div class="container mt-4">
        <div class="row justify-content-end">
            <div class="col-md-4">
                <form action="{{ route('kategori.penutup-ruangan') }}" method="get" id="filterForm">
...
<script>
    $(document).ready(function() {
        ...
        $('#filterForm').submit(function(e) {
            ...
            window.location.href = '/penutup-ruangan?sort_by=' + $('#sort_by').val() + '&query=' + query;
        });
    });
</script>
@endsection

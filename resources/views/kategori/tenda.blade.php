...
<div class="header-categories container fluid w-full h-30 bg-primary p-1 rounded">
    <p class="fs-1 text-center text-light">Tenda Sarnafil</p>
    ...
    <div class="container-fluid">
        <div class="container mt-4">
            <div class="row justify-content-end">
                <div class="col-md-4">
                    <form action="{{ route('kategori.tenda') }}" method="get" id="filterForm">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#filterForm').submit(function(e) {
                ...
                window.location.href = '/tenda?sort_by=' + $('#sort_by').val() + '&query=' + query;
            });
        });
    </script>
@endsection

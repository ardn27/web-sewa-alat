...
@section('layout.content')
    ...
    <div class="header-categories container fluid w-full h-30 bg-warning p-1 rounded">
        <p class="fs-1 text-center text-light">Meja Kursi & Sofa</p>
    ...
    <div class="container-fluid">
        <div class="container mt-4">
            <div class="row justify-content-end">
                <div class="col-md-4">
                    <form action="{{ route('kategori.kursimeja') }}" method="get" id="filterForm">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#filterForm').submit(function(e) {
                e.preventDefault();
                window.location.href = '/tempat-duduk?sort_by=' + $('#sort_by').val();
            });
        });
    </script>
@endsection

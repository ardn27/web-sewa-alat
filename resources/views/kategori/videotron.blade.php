...
@section('layout.content')
    ...
    <div class="header-categories container fluid w-full h-30 bg-primary p-1 rounded">
        <p class="fs-1 text-center text-light">LED Videotron</p>
    ...
    <div class="container mt-4">
        <div class="row justify-content-end">
            <div class="col-md-4">
                <form action="{{ route('kategori.videotron') }}" method="get" id="filterForm">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#filterForm').submit(function(e) {
                ...
                window.location.href = '/videotron?sort_by=' + $('#sort_by').val() + '&query=' + query;
            });
        });
    </script>
@endsection

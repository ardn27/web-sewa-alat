...
@section('title', 'Pendingin Ruangan & AC')
...
@section('layout.content')
    ...
    <div class="header-categories container fluid w-full h-30 p-1 rounded" style="margin-top:7rem; ">
        <p class="fs-1 text-center text-light">Pendingin Ruangan & AC</p>
    ...
    <div class="container-fluid mt-4">
        <div class="container mt-4">
            <div class="row justify-content-end">
                <div class="col-md-4">
                    <form action="{{ route('kategori.pendingin') }}" method="get" id="filterForm">
                        <div class="row g-2 g-lg-3 align-items-center">
                            ...
                            <div class="col">
                                <select name="sort_by" id="sort_by" class="form-select">
                                    <option value="--filter--" {{ $sortBy == '--filter--' ? 'selected' : '' }}>--Filter--
                                        </option>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#filterForm').submit(function(e) {
                ...
                window.location.href = '/pendingin?sort_by=' + $('#sort_by').val() + '&query=' + query;
            });
        });
    </script>
@endsection

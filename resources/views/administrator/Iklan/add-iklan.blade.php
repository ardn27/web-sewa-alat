        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- body -->
                    <form action="/add-iklan" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="exampleInputText" class="form-label">Judul Iklan</label>
                            <input type="text" class="form-control" id="judul_iklan" name="judul_iklan"
                                aria-describedby="emailHelp">
                            <div id="emailHelp" class="form-text"></div>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputText" class="form-label">Link Produk</label>
                            <input type="text" class="form-control" id="link_produk" name="link_produk"
                                aria-describedby="emailHelp">
                            <div id="emailHelp" class="form-text"></div>
                        </div>
                         <!-- form text field -->
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; SabdhaLangit 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->

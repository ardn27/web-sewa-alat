           ...
           <div id="content-wrapper" class="d-flex flex-column">
               ...
               <div id="content">
                   ...
                   <div class="container-fluid">
                       <!-- Page Heading -->
                       <h1 class="h3 mb-2 text-center text-gray-800">PRODUK</h1>
                       @if (session('success'))
                           ...
                           <div class="card-body">
                               <div class="table-responsive">
                                   <table class="table table-bordered" id="dataTable" width="100%" cellspacing="">
                                       ...
                                       <tbody>
                                           @foreach ($product as $data)
                                               <tr>
                                                   ...
                                                   <td><img src="{{ asset('public/image/' . $data->gambar) }}"
                                                           alt="Gambar Produk" style="max-width: 80px"></td>
                                                   <td>
                                                       <a href="/edit-post/{{ $data->id }}"
                                       ...
                                       <a href="/add-post" class="btn btn-primary mb-2">Tambah</a>
                                   </table>
                                   <div class="d-flex justify-content-center">
                                       {{ $product->links() }} <!-- Paginasi -->
                                   </div>
                               </div>
                           </div>
                       </div>

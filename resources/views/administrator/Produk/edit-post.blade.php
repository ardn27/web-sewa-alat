        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- body -->
                    <form action="/edit-post-action" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-control" name="kategori" id="kategori">
                                ...
                                <option value="Pendingin">Pendingin/AC</option>
                                <option value="Penutup Ruangan">Penutup Ruangan</option>
                                <option value="Kursi dan Meja">Kursi & Meja</option>
                        ...
                        <!-- end form text field -->
                         ...
                         <div class="mb-3">
                            ...
                            <input type="file" name="gambar" id="gambar" class="form-control" value="{{ $data->gambar }}">
                            <img class="image-fluid mb-3" src="{{ asset('public/image/' . $data->gambar) }}" alt="" style="max-width: 200px">
                        </div>
                        <!-- end form text field -->
                        <!-- form text field -->
                        <div class="mb-3">
